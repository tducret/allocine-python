...
__version__ = '0.0.10'  # Should match with __init.py__
...
# export VERSION=0.0.10; git tag $VERSION -m "Ajout de Hong Kong dans la liste des nationalités"; git push --tags
